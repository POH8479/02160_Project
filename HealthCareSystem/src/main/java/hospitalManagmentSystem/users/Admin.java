...
public class Admin extends User implements HealthStaff{
	 ...
	 */
	public Admin(String usersName, String usersAddress, int phone) {
		// super
	 ...
	 * @return The new User
	 */
	public User addUser(String usersName, String usersAddress, int phone, String typeOfUser) {
		...
		if(typeOfUser.toLowerCase().equals("admin")) {
			...
			// create a new Doctor
			Doctor newDoctor = new Doctor(usersName, usersAddress, phone, speciality);
